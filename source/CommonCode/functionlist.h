...
FUNC (false, _rem_setSoundLoopPoints)
...
FUNC (false, _rem_setCharacterAA)
FUNC (false, _rem_setMaximumAA)
...
FUNC (true, rotateCharacter)
FUNC (true, ponder)
FUNC (true, addSoundQ)
FUNC (true, replaceSoundQ)
FUNC (true, stopSoundQ)
FUNC (true, pauseSoundQ)
FUNC (true, resumeSoundQ)
FUNC (true, setSoundQLoop)
FUNC (true, setSoundQVolume)
FUNC (true, setDefaultSoundQVolume)
