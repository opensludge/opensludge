...
void addToStringArray (stringArray * & theArray, const char * theString, int start = 0, int size = -1, bool trimSpa = true, bool translate = true);
...
int findOrAddUntranslateable (stringArray * & sA, const char * addString, bool = true);
