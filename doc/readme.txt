...
The OpenSLUDGE project contains source code for lots of SLUDGE applications, including the project manager, compiler and engine. Originally, they've only ever been compiled using CodeWarrior, but now it compiles in both Xcode on Mac, Dev-C++ on Windows and GNU make on Linux. (The engine, at least. The Dev Kit is currently only working on Mac.)

For Linux compilation instructions, see INSTALL_LINUX.
